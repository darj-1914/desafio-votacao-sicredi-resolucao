...
public class VotoControllerV1 {
    ...
    public VotoControllerV1(VotoService votoService, PautaService pautaService, CpfClient cpfClient) {
    ...
    public ResponseEntity<?> votar(@RequestBody Map<String, String> payload) {
        try {
            ...
            if (e.getMessage() != null && e.getMessage().contains("Pauta não encontrada")) {
                return ResponseEntity.notFound().build();
            }
